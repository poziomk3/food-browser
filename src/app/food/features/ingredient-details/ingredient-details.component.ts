...
import { IngredientService, Product } from '../../data-access/ingredient.service'
...
export class IngredientDetailsComponent implements OnInit, OnDestroy {
    ...
    ngOnInit(): void {
        ...
        this.id$ = this.route.params
            .pipe(map((params) => params['id']),tap(data=>{this.ingredientDetails$ = this.ingredientsService.getProductDetailsById(data)}))
            .subscribe()
    }
}
